...
const ItemSchema = CollectionSchema(
  ...
  links: {},
  embeddedSchemas: {r'Sku': SkuSchema},
  getId: _itemGetId,
...
int _itemEstimateSize(
  ...
  bytesCount += 3 + object.skus.length * 3;
  {
    final offsets = allOffsets[Sku]!;
    for (var i = 0; i < object.skus.length; i++) {
      final value = object.skus[i];
      bytesCount += SkuSchema.estimateSize(value, offsets, allOffsets);
    }
  }
  return bytesCount;
}
...
Item _itemDeserialize(
  ...
  object.skus = reader.readObjectList<Sku>(
        offsets[1],
        SkuSchema.deserialize,
        allOffsets,
        Sku(),
      ) ??
      [];
  object.status = _ItemstatusValueEnumMap[reader.readByteOrNull(offsets[2])] ??
      Status.draft;
  return object;
}
...
P _itemDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (reader.readObjectList<Sku>(
            offset,
            SkuSchema.deserialize,
            allOffsets,
            Sku(),
...
extension ItemQueryFilter on QueryBuilder<Item, Item, QFilterCondition> {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> skusLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> skusIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'skus',
        0,
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> skusIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'skus',
        0,
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> skusLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> skusLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> skusLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> statusEqualTo(Status value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'status',
        value: value,
...
extension ItemQueryObject on QueryBuilder<Item, Item, QFilterCondition> {
  QueryBuilder<Item, Item, QAfterFilterCondition> skusElement(
      FilterQuery<Sku> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'skus');
    });
  }
}
...
extension ItemQueryProperty on QueryBuilder<Item, Item, QQueryProperty> {
  ...
  QueryBuilder<Item, List<Sku>, QQueryOperations> skusProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'skus');
    });
  }

  QueryBuilder<Item, Status, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
...
const SkuSchema = Schema(
  ...
  estimateSize: _skuEstimateSize,
  serialize: _skuSerialize,
  deserialize: _skuDeserialize,
  deserializeProp: _skuDeserializeProp,
);

int _skuEstimateSize(
  Sku object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
...
extension SkuQueryFilter on QueryBuilder<Sku, Sku, QFilterCondition> {
  QueryBuilder<Sku, Sku, QAfterFilterCondition> addressIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'address',
      ));
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> addressIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'address',
      ));
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> addressEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> addressGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> addressLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> addressBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> addressStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> addressEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> addressContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'address',
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> addressMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'address',
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> addressIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'address',
        value: '',
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> addressIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'address',
        value: '',
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> nameIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'name',
      ));
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> nameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'name',
      ));
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> nameEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> nameGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> nameLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> nameBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> nameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> nameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> nameContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'name',
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> nameMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'name',
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'name',
        value: '',
  ...
  QueryBuilder<Sku, Sku, QAfterFilterCondition> nameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'name',
        value: '',
...
extension SkuQueryObject on QueryBuilder<Sku, Sku, QFilterCondition> {}
